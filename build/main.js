...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {services: a, selected_service_name: b, hostname: c, uploaded_log_url: d};
	});
				...
				if (_p2._0.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								uploaded_log_url: _elm_lang$core$Basics$toString(_p2._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
	...
	var viewUploadLogs = A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Having trouble? Click here to upload your logs.'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
	...
	var viewServicesList = A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Choose a service to run:'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					A2(
						...
						function (service) {
							return A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$core$Native_Utils.eq(service.name, model.selected_service_name) ? _elm_lang$html$Html$text(service.name) : A2(
										_elm_lang$html$Html$a,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href('javascript: return false;'),
