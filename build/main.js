...
var _user$project$Main$logsUploadedDecoder = A2(_elm_lang$core$Json_Decode$field, 'output', _elm_lang$core$Json_Decode$string);
...
var _user$project$Main$initialState = function (_p0) {
	var _p1 = _p0;
	var _p2 = _rundis$elm_bootstrap$Bootstrap_Navbar$initialState(_user$project$Main$NavbarMsg);
...
var _user$project$Main$subscriptions = function (model) {
	return A2(_rundis$elm_bootstrap$Bootstrap_Navbar$subscriptions, model.navbarState, _user$project$Main$NavbarMsg);
};
		...
		_elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'command',
					_1: _elm_lang$core$Json_Encode$string('pastebinit')
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$list(
							{
								ctor: '::',
								_0: _elm_lang$core$Json_Encode$string('-b'),
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Json_Encode$string('sprunge.us'),
									_1: {
										ctor: '::',
										_0: _elm_lang$core$Json_Encode$string('/mnt/host/var/log/syslog'),
										_1: {ctor: '[]'}
									}
								}
							})
...
var _user$project$Main$view = function (model) {
	var viewServiceEmbed = A2(
		...
		{ctor: '[]'});
	var viewUploadLogs = A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: (_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$String$length(model.uploaded_log_url),
				0) > 0) ? _rundis$elm_bootstrap$Bootstrap_Alert$info(
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Your logs have been uploaded: '),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$a,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href(model.uploaded_log_url),
										_1: {
											ctor: '::',
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(model.uploaded_log_url),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
			...
			_0: A2(
				...
				A2(
						...
						_0: _rundis$elm_bootstrap$Bootstrap_Navbar$dropdown(
							{
								...
								items: A2(
									_elm_lang$core$List$map,
									function (service) {
										return _elm_lang$core$Native_Utils.eq(service.name, model.selected_service_name) ? A2(
											...
											_rundis$elm_bootstrap$Bootstrap_Navbar$dropdownItem,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Main$ServiceSelect(service.name)),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
									...
									A2(
										_elm_lang$core$List$filter,
										function (service) {
											return !_elm_lang$core$Native_Utils.eq(service.name, model.selected_service_name);
										},
										model.services))
							}),
						_1: {
							...
							_0: _rundis$elm_bootstrap$Bootstrap_Navbar$dropdown(
								{
									...
									toggle: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Get Help'),
											_1: {ctor: '[]'}
										}),
									items: {
										ctor: '::',
					...
					A3(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('AstroSwarm'),
							_1: {ctor: '[]'}
						},
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Main$initialState, view: _user$project$Main$view, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (hostname) {
			return _elm_lang$core$Json_Decode$succeed(
